...
What he could not do was run the full sensor suite at the full loop rate. The processing boards he had installed — the neural accelerators from Grisha's back shelf, old but capable — handled the control loop and the motor coordination well enough. They were, in fact, better than anything he could have requisitioned through the university: whoever had designed them had built for parallel signal integration in a way that suited Alexei's architecture as if by accident. But he had wired the statue with more sensors than the thesis required, because Nerd Alexei had a quiet conviction, which he did not examine, that a thing worth making was worth making well. Pressure sensors in the fingertips. Accelerometers at every joint. A small suite of environmental sensors — temperature, ambient sound, light — in the skull cavity, for reasons Alexei would have described as *completeness* rather than *necessity* if asked. Together the sensors produced more data than even those boards could usefully integrate in real time.

He needed more compute. The lab had some. The lab's compute was shared across three other ongoing projects and was, on any given afternoon, saturated.
